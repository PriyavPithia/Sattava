...
import { FileText, Youtube, FolderOpen, ArrowLeft, BookOpen, Loader2 } from 'lucide-react';
        ...
        <div className="p-4 border-t border-gray-200 flex-shrink-0">
          <div className="mb-4">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm"
            >
              {generatingNotes ? (
                <>
          ...
          <button
            ...
            className="w-full mt-2 px-4 py-2 bg-black text-white rounded-lg disabled:opacity-50 hover:bg-gray-800 transition-colors duration-200 flex items-center justify-center gap-2"
          >
            {askingQuestion ? (
              <>
                <Loader2 className="w-4 h-4 animate-spin" />
